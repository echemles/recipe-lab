  ...
  return (
    <div className="flex flex-col items-center gap-3 w-full">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 w-full">
        <div className="px-3 py-2 rounded-lg border border-red-500/30 bg-red-500/10 text-red-700 dark:text-red-400 text-sm font-medium">
          Find recipe
        </div>
...
function RecipeLabFlow() {
  return (
    <div className="flex flex-col items-center gap-3 w-full">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 w-full">
        <div className="px-3 py-2 rounded-lg border border-green-500/40 bg-green-500/10 text-green-700 dark:text-green-400 text-sm font-medium">
          Your pantry
        </div>
        <svg className="w-4 h-4 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
      ...
      <div className="text-xs text-green-600 dark:text-green-400 mt-1 text-center">Components reuse across many meals</div>
    </div>
  );
}
...
export function InsightSection() {
  ...
  return (
    <section ref={ref} className="landing-section py-20 md:py-32 px-6 relative overflow-hidden flex items-center">
      <GradientOrb
        color="blue"
        size="md"
      ...
      <div className="max-w-5xl mx-auto relative z-10 w-full">
        <motion.h2
          ...
          className="text-2xl sm:text-3xl md:text-5xl font-semibold mb-6 text-center md:text-left"
        >
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl text-muted leading-relaxed max-w-3xl mb-8 sm:mb-12 text-center md:text-left"
        >
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
          <motion.div
            ...
            className="w-full max-w-full p-6 sm:p-8 rounded-2xl border border-red-500/20 bg-red-500/5"
          >
            <TraditionalFlow />
            <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-red-500/20 space-y-2.5 sm:space-y-3 text-sm text-muted leading-relaxed">
          ...
          <motion.div
            ...
            className="w-full max-w-full p-6 sm:p-8 rounded-2xl border border-green-500/30 bg-green-500/5"
          >
            <RecipeLabFlow />
            <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-green-500/20 space-y-2.5 sm:space-y-3 text-sm text-muted leading-relaxed">
              <div className="flex items-start gap-3">
